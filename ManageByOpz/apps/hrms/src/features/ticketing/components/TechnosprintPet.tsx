...
"bg-blue-400"
 ...
 >
 {isTrackerOn && (
 <div className="absolute top-[-30px] bg-indigo-600/90 text-white text-[9px] px-2 py-0.5 rounded-full font-semibold animate-pulse shadow-md z-20 whitespace-nowrap flex items-center gap-1 border border-indigo-400/30">
 ...
 <span className="text-[9px] font-semibold text-blue-500 uppercase tracking-widest flex items-center gap-1">
 ...
 <span className="text-[9px] opacity-80 uppercase tracking-widest font-semibold">AI Ticket Companion</span>
 </div>
 </div>
 <button 
 ...
 <span className="text-[9px] font-semibold text-indigo-500 uppercase tracking-widest flex items-center gap-1">
 ...
 <div>
 <div className="text-[9px] text-muted-foreground uppercase font-semibold">{c.label}</div>
 ...
 <div className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground">Recent Ticket Activity</div>
...
"In Progress":"bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400",
 ...
 <span className={`px-1.5 py-0.5 rounded font-semibold text-[8px] uppercase ${colorClass}`}>
 {ticket.status}
 </span>
 </Link>
 );
