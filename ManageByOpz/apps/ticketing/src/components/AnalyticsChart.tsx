...
export default function AnalyticsChart({ type, title, data }: AnalyticsChartProps) {
 ...
 <h3 className="text-[10px] font-semibold uppercase tracking-widest text-muted-foreground mb-4 self-start">{title}</h3>
 ...
 <h3 className="text-[10px] font-semibold uppercase tracking-widest text-foreground">{title}</h3>
 </div>
