...
import { Card, CardContent, CardHeader, CardTitle } from "@managemyopz/platform-ui";
import { Input } from "@managemyopz/platform-ui";
import { Button } from "@managemyopz/platform-ui";
import { Badge } from "@managemyopz/platform-ui";
import {
 Building2,
 Search,
 Phone,
...
export function Companies() {
 ...
 <div
 className="w-12 h-12 rounded-xl flex items-center justify-center text-white text-lg font-semibold shadow-lg bg-gradient-to-br from-indigo-500 to-indigo-700"
 >
...
"flex items-center gap-2 py-3 text-xs font-semibold border-b-2 transition-colors",
 ...
 <p className="truncate"><span className="font-semibold text-slate-500">SMTP:</span> {mappedConfig.smtpHost || mappedConfig.smtp_host}:{mappedConfig.smtpPort || mappedConfig.smtp_port}</p>
 <p className="truncate"><span className="font-semibold text-slate-500">IMAP:</span> {mappedConfig.imapHost || mappedConfig.imap_host}:{mappedConfig.imapPort || mappedConfig.imap_port}</p>
 </div>
 </div>
 ) : (
 ...
 <div
 className="w-9 h-9 rounded flex items-center justify-center text-white text-[10px] font-semibold shrink-0 shadow-sm bg-gradient-to-br from-indigo-500 to-indigo-700"
 >
