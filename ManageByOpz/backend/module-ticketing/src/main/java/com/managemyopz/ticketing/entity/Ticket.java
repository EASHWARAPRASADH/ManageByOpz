...
// Enterprise Standard §1.1 — extends BaseLongEntity for auto-managed createdAt/updatedAt
...
public class Ticket extends BaseLongEntity {
    ...
    // createdAt and updatedAt are inherited from BaseEntity (auto-managed by JPA Auditing)
}
